...
declare module 'mojang-gametest' {
	...
	export class SimulatedPlayer {
		 ...
		 * @throws This property can throw when used.
		 */
		readonly 'headRotation': mojangminecraft.ScriptPlayerHeadRotation
		/**
		...
		navigateToBlock(
			blockLocation: mojangminecraft.BlockLocation,
			speed: number
		): mojangminecraft.ScriptNavigationResult
		/**
		 * @remarks
		 ...
		 * @throws This function can throw errors.
		 */
		navigateToEntity(entity: mojangminecraft.Entity, speed: number): mojangminecraft.ScriptNavigationResult
		/**
		 * @remarks
	...
	export class Test {
		 ...
		 * ```
		 */
		spawnItem(itemStack: mojangminecraft.ItemStack, location: Location): mojangminecraft.Entity
		/**
		 * @remarks
